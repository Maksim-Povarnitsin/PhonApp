            ...
            while (!command.ToLower().Contains("quit"))
            {
                ...
                switch (command)
                {
                    ...
                    case "add":
                        ...
                        employeesList.Add(new EmployeesDTO() { Name = name, Phone=phone}); //PM
                    ...
                    case "del":
                        ...
                        {
                            if (indexToDelete > 0 && indexToDelete <= employeesList.Count())//PM
                            {
                                employeesList.RemoveAt(indexToDelete-1);//PM
                            }
                        }
                        break;
                }
